...
{
    py::module_ random = module.def_submodule("random", "Random number generation.");
    py::class_<Random>(random, "Random", "Uniform random number generator; seeded from the clock unless given a seed.")
        .def(py::init<>())
